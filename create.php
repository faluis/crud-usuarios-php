...
<title>CRUD con PHP usando POO</tittle>
...
<body>
  <div class="container">
    ...
    <div class="col-md-6">
      ...
      <input type="text" name="telefono" id="relefono" class="form-control" maxlength="100" required>
    </div>
    <div class="col-md-6">
    ...
    <hr>
      <button type="summit" class="btn btn-success">Guardar datos</button>
      </div>
      </form>
    </div>
  </div>
